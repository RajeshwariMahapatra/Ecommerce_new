...
class Users
{
    ...
    public function insert()
    {
        ...
        // Insert the User
        $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
        $sql = "INSERT INTO Users (user_identity, user_name, user_password, user_email, user_contact_no, user_country_code, user_created_at, user_birthdate, user_status, user_address_line1, user_address_line2, user_address_city, user_address_state_id, user_address_country_id, user_address_pin_code) 
            VALUES (:user_identity, :user_name, :user_password, :user_email, :user_contact_no, :user_country_code, FROM_UNIXTIME(:user_created_at), :user_birthdate, :user_status, :user_address_line1, :user_address_line2, :user_address_city, :user_address_state_id, :user_address_country_id, :user_address_pin_code)";
        $st = $conn->prepare($sql);
