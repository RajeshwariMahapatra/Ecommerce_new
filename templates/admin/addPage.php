<?php include 'templates/admin/include-admin/admin-header.php'; ?>
                ...
                <div class="container">
                    ...
                    <form action="admin.php?action=<?php echo $results['formAction'] ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="page_coverimage">Cover Image URL</label>
                            <input type="text" id="page_coverimage" name="page_coverimage" class="form-control" value="<?php echo htmlspecialchars($results['page']->page_coverimage) ?>">
                        </div>
                        <div class="form-group">
